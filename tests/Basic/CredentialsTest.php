...
class CredentialsTest extends TestCase
{
    ...
    {
        $credentials1 = new Credentials(['username' => 'foo', 'password' => 'bar']);
        $credentials2 = new Credentials(['username' => 'foo', 'password' => 'bar']);
        $credentials3 = new Credentials(['username' => 'foo', 'password' => 'baz']);
